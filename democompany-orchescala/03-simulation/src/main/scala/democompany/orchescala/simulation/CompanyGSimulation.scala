...
import democompany.orchescala.engine.{CompanyEngineC7Config, CompanyEngineC8Config, CompanyEngineGClient, CompanyEngineGConfig}
...
trait CompanyGSimulation extends CompanySimulation, CompanyEngineGConfig:
  ...
  override def engineZIO: ZIO[Any, Nothing, ProcessEngine] =
    (for
      c8Engine: ProcessEngine <- CompanyC7Simulation.engineZIO
